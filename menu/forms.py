...
class BicicletaForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'nombre': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Nombre de la bicicleta'}),
...
class RepuestoForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'categoria': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Categoría'}),
            'marca': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Marca'}),
            'numero_parte': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Número de parte'}),
            'compatibilidad': forms.Textarea(attrs={'class': 'form-control', 'rows': 2, 'placeholder': 'Describe la compatibilidad con bicicletas'}),
            'imagen': forms.FileInput(attrs={'class': 'form-control', 'accept': 'image/*'}),
            'stock': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': '0'})
        }
        labels = {
